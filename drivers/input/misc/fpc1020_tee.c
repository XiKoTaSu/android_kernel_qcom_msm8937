...
static int fpc1020_probe(struct platform_device *pdev)
{
	...
	fpc1020->ttw_wl.name = "fpc_ttw_wl";
	wakeup_source_add(&fpc1020->ttw_wl);
	fpc1020->fpc_wl.name = "fpc_wl";
	wakeup_source_add(&fpc1020->fpc_wl);
	fpc1020->fpc_irq_wl.name = "fpc_irq_wl";
	wakeup_source_add(&fpc1020->fpc_irq_wl);
...
static int fpc1020_remove(struct platform_device *pdev)
{
	...
	/* 移除 wakeup sources */
	wakeup_source_remove(&fpc1020->ttw_wl);
	wakeup_source_remove(&fpc1020->fpc_wl);
	wakeup_source_remove(&fpc1020->fpc_irq_wl);
